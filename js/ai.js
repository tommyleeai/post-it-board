                ...
                body: JSON.stringify({
                    ...
                    generationConfig: {
                        ...
                        responseSchema: {
                            ...
                            required: ["hasIntent", "eventTime", "alertTime", "reason", "repeatRule", "needsClarification", "clarificationQuestion", "conflictWarning", "hasStockAlert", "stockSymbol", "stockTargetPrice", "stockCondition", "stockAlertReason"]
                        }
                    }
                })
            });
